			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="nav nav-pills">
					...
					<li class="nav-item dropdown"><a
						...
						id="disasterDropdown" role="button"> 재난현황 </a>
					...
					<!-- 날씨 메뉴 드롭다운  -->
					<li class="nav-item dropdown"><a
						class="nav-link text-dark fw-bolder" href="#" id="weatherDropdown"
						role="button"> 서울날씨 </a>
						<ul class="dropdown-menu" aria-labelledby="weatherDropdown">
							<li><a class="dropdown-item" href="${CP}/weather">날씨</a></li>
							<li><a class="dropdown-item" href="${CP}/air_quality">대기환경</a></li>
						</ul></li>

					<!-- 재난안전시설 메뉴 드롭다운  -->
					<li class="nav-item dropdown"><a
						class="nav-link text-dark fw-bolder" href="#"
						id="facilitieDropdown" role="button"> 재난안전시설 </a>
					...
					<li class="nav-item dropdown"><a
						class="nav-link text-dark fw-bolder" href="#"
						id="preparationDropdown" role="button"> 재난대비 </a>
					...
					<li class="nav-item dropdown"><a
						class="nav-link text-dark fw-bolder" href="#"
						id="insuranceDropdown" role="button"> 시민안전보험 </a>
					...
					<li class="nav-item dropdown"><a
						class="nav-link text-dark fw-bolder" href="#"
						id="medicalInstDropdown" role="button"> 응급의료기관 </a>
						<ul class="dropdown-menu" aria-labelledby="medicalInstDropdown">
							<li><a class="dropdown-item" href="${CP}/er_medi_inst/list">응급의료기관 정보</a></li>
							<li><a class="dropdown-item" href="${CP}/er_medi_inst/er_bed">응급실 가용병상 현황</a></li>
						</ul></li>

					<!-- 재난안전게시판 -->
					<li class="nav-item dropdown"><a
						class="nav-link text-dark fw-bolder" href="#" id="boardDropdown"
