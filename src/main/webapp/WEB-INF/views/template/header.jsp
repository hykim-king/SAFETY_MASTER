...
<header id="header" class="mx-1 mt-4">
  <nav class="navbar navbar-expand-lg navbar-light">
    <div class="container-fluid">
      <a class="navbar-brand text-dark fs-2" href="${CP}/index"
        >서울365 안전포털</a
      >
      <button
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="nav nav-pills">
          ...
          <li class="nav-item dropdown">
            <a
              class="nav-link text-dark fw-bolder"
              href="#"
              id="disasterDropdown"
              role="button"
            >
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="weatherDropdown">
              ...
              <li>
                <a class="dropdown-item" href="${CP}/air_quality">대기환경</a>
              </li>
            </ul>
          </li>
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="preparationDropdown">
              <li>
                <a class="dropdown-item" href="#">재난 경보 소리 테스트</a>
              </li>
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="medicalInstDropdown">
              <li>
                <a class="dropdown-item" href="${CP}/er_medi_inst/list"
                  >응급의료기관 정보</a
                >
              </li>
              <li>
                <a class="dropdown-item" href="${CP}/er_medi_inst/er_bed"
                  >응급실 가용병상 현황</a
                >
              </li>
            </ul>
