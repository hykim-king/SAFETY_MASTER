				...
				<ul class="nav nav-pills">
					...
					<li class="nav-item dropdown"><a class="nav-link text-dark fw-bolder"
						...
						<ul class="dropdown-menu" aria-labelledby="facilitieDropdown">
							<li><a class="dropdown-item" href="/acmdfclty/view">지진 옥외 대피 장소</a></li>
							<li><a class="dropdown-item" href="/hanpa/view">한파 응급 대피소</a></li>
							<li><a class="dropdown-item" href="/faclt/view">비상 대피 시설</a></li>
					...
					<li class="nav-item dropdown"><a class="nav-link text-dark fw-bolder"
						...
						<ul class="dropdown-menu" aria-labelledby="preparationDropdown">
							...
							<li><a class="dropdown-item" href="/checklist">생존 필수품 추천 및 체크리스트</a></li>
							<li><a class="dropdown-item" href="/videopost/list">재난 훈련 영상</a></li>
