					...
					<div
						...
						<div class="dropdown mb-1">
							<button class="btn btn-dark dropdown-toggle text-dark"
								...
								aria-expanded="false">${wc.gu_Nm}</button>
					...
					<c:forEach var="wf" items="${wf_List}">
						<div class="col-md-2 forecast-card">
							<div class="card text-center p-3">
								...
								<img class="rounded mx-auto d-block"
									src="https://openweathermap.org/img/wn/${wf.weather_Icon_Id}@2x.png"
									height="70" width="70">
			...
			<table class="table table-bordered border-dark text-center w-75">
				...
				<tbody>
					...
					<tr>
						...
						<c:forEach var="wf3" items="${wf3_List}">
							<td><img class="rounded mx-auto d-block"
								src="https://openweathermap.org/img/wn/${wf3.weather_Icon_Id}@2x.png"
					...
					<tr>
						...
						<c:forEach var="wf3" items="${wf3_List}">
							<td class="text-danger">${wf3.max_Temp}°</td>
						</c:forEach>
					...
					<tr>
						...
						<c:forEach var="wf3" items="${wf3_List}">
							<td class="text-primary">${wf3.min_Temp}°</td>
						</c:forEach>
